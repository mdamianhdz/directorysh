...
public class Usertype implements Serializable {
    ...
    public String toString() {
        return "Userstype{" + "id=" + id + ", name=" + name + ", updateContacts=" + updateContacts + ", updatePhones=" + updatePhones + ", updateUsers=" + updateUsers + ", updateDepartments=" + updateDepartments + ", updateConfiguration=" + updateConfiguration + ", createContacts=" + createContacts + ", createPhones=" + createPhones + ", createUsers=" + createUsers + ", createDepartments=" + createDepartments + ", deleteContacts=" + deleteContacts + ", deletePhones=" + deletePhones + ", deleteUsers=" + deleteUsers + ", deleteDepartments=" + deleteDepartments + ", queryContacts=" + queryContacts + ", queryPhones=" + queryPhones + ", queryUsers=" + queryUsers + ", queryDepartments=" + queryDepartments + '}';
    }
}
